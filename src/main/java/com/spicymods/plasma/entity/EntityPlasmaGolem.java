package com.spicymods.plasma.entity;
...
public class EntityPlasmaGolem extends EntityGolem {

    protected static final DataParameter<Byte> PLAYER_CREATED = EntityDataManager.<Byte>createKey(EntityPlasmaGolem.class, DataSerializers.BYTE);
    ...
    public EntityPlasmaGolem(World worldIn) {
        super(worldIn);
    ...
    public static void registerFixesIronGolem(DataFixer fixer) {
        EntityLiving.registerFixesMob(fixer, EntityPlasmaGolem.class);
    }
